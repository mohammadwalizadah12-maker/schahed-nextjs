...
const STORY: Record<Locale, {
  ...
  fa: {
    ...
    introBody:
      "مؤسسه خیریه شاهد از سال ۲۰۱۲ و با شماره ثبت VR 21688 در قالب یک سازمان غیرانتفاعی-غیردولتی با انگیزه تقویت و حمایت کودکان فقیر، آسیبپذیر و بیخانمان در افغانستان کار خود را آغاز کرده است. در طول یازده سال فعالیت، شاهد با بهرهگیری از کمکهای انساندوستانه مردم نیکوکار و تلاش پیگیر نیروهای داوطلب و موظف به موفقیتهای چشمگیری دست یافته و به یکی از قطبهای حمایتی شهروندان مقیم و خارج از افغانستان تبدیل شده است. شاهد تا پایان سال ۲۰۲۲ بیش از ۲۰۰ خانواده نیازمند و ۷۰۰ دانشآموز دختر و پسر را تحت حمایت موقت یا طولانیمدت خود قرار داده است.",
    historyTitle: "تاریخچه و نحوه تأسیس",
    historyBody:
      "موسسه خیریه شاهد در سال ۲۰۱۲ در شهر هامبورگ آلمان به ثبت رسید. ایده اولیه تأسیس توسط آقای محمد زرگرپور مطرح شد و اعضای هیئت امنا با ۱۱ عضو اقدام به تأسیس این مجموعه کردند که از این جمع، ۹ نفر همچنان به فعالیت خیرخواهانه خود ادامه میدهند. بنیانگذاران بر این باور بودند که یک مؤسسه نمیتواند تنها با اتکا به شخص یا گروه محدودی این راه را طی کند؛ از اینرو شاهد با شعار «هرگاه طفلی باسواد بشود، یک خانواده از فقر نجات پیدا خواهد کرد» به ثبت رسید.",
    visionTitle: "بیانیه چشمانداز",
    visionBody:
      "باور ما این است که هرگاه فردی از یک خانواده نیازمند باسواد شود، آن خانواده به سوی سعادت و تأمین معیشت خود حرکت خواهد کرد. در همین راستا تا امروز ۲۵ پروژه در دست کار قرار گرفته که تعدادی به بهرهبرداری رسیدهاند؛ با عناوین دارالقران، مدارس خصوصی و عمومی، یتیمخانه و مانند آن. قدم دوم، ایجاد زمینههای کاری و اشتغالزایی است. در نتیجه، خودکفایی خانوادههای تحت پوشش با ابزار آگاهی و سوادآموزی، مهمترین هدف چشمانداز پنجساله موسسه خیریه شاهد است.",
    ceoTitle: "پیام مدیرعامل",
    ceoBody:
      "از بدو تأسیس، برابری و جلوگیری از هرگونه تبعیض برای هیئت مؤسس یک اصل اساسی بوده است. شاهد تا امروز در ولایات مختلف افغانستان، بدون هیچ استثنائی، بدون اعطای امتیاز به فرد یا ناحیهای خاص و بدون در نظر گرفتن طایفه، نژاد و زبان مددجو و با رعایت کامل اصل بیطرفی و برابری، به هموطنان خود مددرسانی کرده است. موافقت دولت آلمان با شاهد پس از نظارت دقیق بر فعالیتهای آن، مهر تأییدی بر رعایت این اصول است.",
