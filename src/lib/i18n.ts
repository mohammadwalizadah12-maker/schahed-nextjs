...
export const MESSAGES: Record<Locale, Dict> = {
  ...
  fa: {
    ...
    "appeal.p1":
      "دههها بحران و ناامنی، زیرساخت‌های اجتماعی و اقتصادی افغانستان را ویران کرده و میلیون‌ها انسان را با مشکلات سخت زندگی روبهرو ساخته است.",
    "appeal.p2":
      "حمایت شما می‌تواند سهمی ارزشمند در کاهش درد و رنج این انسان‌ها داشته باشد؛ می‌تواند کودکی را از گرسنگی نجات دهد، بیماری را درمان کند و امید را به خانوادهای بی‌پناه بازگرداند.",
    "appeal.p3":
      "امروز زنان بی‌سرپرست، کودکان یتیم، افراد معلول، آوارگان و خانواده‌های نیازمند، بیش از هر زمان دیگری به حمایت و همدلی شما نیاز دارند.",
    "appeal.p4":
      "ما در «موسسه خیریه شاهد» با هدف یاری‌رساندن به نیازمندان و ایجاد پلی میان نیکوکاران و خانواده‌های محروم فعالیت می‌کنیم تا بتوانیم در کنار یکدیگر، آیندهای روشنتر برای انسان‌های نیازمند بسازیم.",
    ...
    "mission.text":
      "موسسه خیریه شاهد یک سازمان غیرانتفاعی و غیردولتی است که در سال ۲۰۱۲ در هامبورگ با شماره ثبت VR 21688 تأسیس شد. در طول بیش از دوازده سال فعالیت، به یکی از قطب‌های حمایتی شهروندان مقیم و خارج از افغانستان تبدیل شده است.",
    "mission.value1.title": "بی‌طرفی و برابری",
    "mission.value1.text":
      "بدون در نظر گرفتن طایفه، نژاد و زبان مددجو و با رعایت کامل اصل بی‌طرفی و برابری به هموطنان خود کمک می‌کنیم.",
    ...
    "mission.value3.text":
      "با ابزار آگاهی، آموزش و اشتغال‌زایی، خانواده‌های تحت پوشش را به خودکفایی میرسانیم؛ مهمترین هدف چشمانداز پنج‌ساله ما.",
    ...
    "prog.hami.text":
      "قدیمیترین طرح ما: هر حامی یک یا چند خانواده نیازمند را تحت حمایت قرار داده و با پرداخت مبلغی به معیشت آنان کمک می‌کند — به‌ویژه زنان سرپرست خانوار و خانواده‌هایی که با بیماری یا از کار افتادگی نانآور مواجهاند.",
    "prog.hami.detail":
    ...
    "prog.danesh.text":
      "از سال ۱۳۹۳ برای تحصیل کودکانی تلاش می‌کنیم که ممکن است به دلیل فقر از آموزش بازبمانند — با تأمین هزینه تحصیل، لوازم، مشاوره و کمک‌هزینه.",
    "prog.danesh.detail":
      "خدمات این طرح سالانه به حدود ۳۰۰۰ دانش‌آموز افغانستانی در مشهد مقدس، تربت جام، کرمان، اصفهان، کابل، هرات و فراه ارائه می‌شود. خدمات: (۱) هزینه‌های عمومی تحصیل (ثبتنام، کتب، بیمه، لباس فرم، سرویس، لوازم‌التحریر، کیف، کفش، لباس گرم)، (۲) کارگاه‌ها و مشاوره تحصیلی و روانشناسی برای دانش‌آموزان و والدین، (۳) مسابقات علمی-انگیزشی، (۴) اردوهای علمی-تفریحی، (۵) همایش‌های انگیزشی، (۶) وام تحصیلی به دانشجویان نیازمند، (۷) پرداخت شهریه دانشگاهی و هزینه پایاننامه.",
    ...
    "feedback.subtitle":
      "بازخورد شما به ما کمک می‌کند کار و این وبسایت را بهتر کنیم. نظر، انتقاد یا پیشنهاد خود را با ما در میان بگذارید.",
