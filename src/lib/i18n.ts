...
export const MESSAGES: Record<Locale, Dict> = {
  de: {
    ...
    "about.ceoTitle": "Botschaft des Geschäftsführers",
    ...
    "about.factsTitle": "Auf einen Blick",
    "about.factSince": "Gegründet",
    "about.factSinceVal": "2012 · Hamburg",
    "about.factRegister": "Registernummer",
    "about.factRegisterVal": "VR 21688",
    "about.factCeo": "Geschäftsführer",
    "about.factCeoVal": "Mohammad Zargarpour",
    "about.factDeputyFin": "Stv. Finanzen",
    "about.factDeputyFinVal": "Seyed Toufigh Hosseini",
    "about.factDeputyAdmin": "Stv. Verwaltung",
    "about.factDeputyAdminVal": "Mohammad Bagher Sabouri",
    "about.factProjects": "Projekte",
    "about.factProjectsVal": "in Afghanistan angestoßen",
    "about.factFounders": "Gründungsmitglieder",
    "about.factFoundersVal": "9 bis heute aktiv",
    "about.historyEyebrow": "Woher wir kommen",
    "about.visionEyebrow": "Wohin wir gehen",
    "about.boardEyebrow": "Der Vorstand",
    "about.boardTitle": "Die Menschen hinter Schahed",
    "about.boardNote": "Eingetragen beim Amtsgericht Hamburg, vom Finanzamt als gemeinnützig anerkannt.",
    "about.photoIntro": "Freiwillige in der Iftar-Küche",
    "about.photoHistory": "Großküche mit Kochkesseln für die Essensausgabe",
    "about.photoVision": "Bereitgestellte Hilfsgüter kurz vor der Verteilung",
  },
  ...
  fa: {
    ...
    "about.historyTitle": "تاریخچه و نحوه تأسیس",
    "about.historyBody": "موسسه خیریه شاهد در سال ۲۰۱۲ در شهر هامبورگ آلمان به ثبت رسید. ایده اولیه تأسیس توسط آقای محمد زرگرپور مطرح شد و اعضای هیئت امنا با ۱۱ عضو اقدام به تأسیس این مجموعه کردند که از این جمع، ۹ نفر همچنان به فعالیت خیرخواهانه خود ادامه می‌دهند. بنیان‌گذاران بر این باور بودند که یک مؤسسه نمی‌تواند تنها با اتکا به شخص یا گروه محدودی این راه را طی کند؛ از این‌رو شاهد با شعار «هرگاه طفلی باسواد بشود، یک خانواده از فقر نجات پیدا خواهد کرد» به ثبت رسید.",
    "about.visionTitle": "بیانیه چشم‌انداز",
    "about.visionBody": "باور ما این است که هرگاه فردی از یک خانواده نیازمند باسواد شود، آن خانواده به سوی سعادت و تأمین معیشت خود حرکت خواهد کرد. در همین راستا تا امروز ۲۵ پروژه در دست کار قرار گرفته که تعدادی به بهره‌برداری رسیده‌اند؛ با عناوین دارالقران، مدارس خصوصی و عمومی، یتیم‌خانه و مانند آن. قدم دوم، ایجاد زمینه‌های کاری و اشتغال‌زایی است. در نتیجه، خودکفایی خانواده‌های تحت پوشش با ابزار آگاهی و سوادآموزی، مهم‌ترین هدف چشم‌انداز پنج‌ساله موسسه خیریه شاهد است.",
    "about.ceoTitle": "پیام مدیرعامل",
    ...
    "about.factsTitle": "در یک نگاه",
    "about.factSince": "سال تأسیس",
    "about.factSinceVal": "۲۰۱۲ · هامبورگ",
    "about.factRegister": "شماره ثبت",
    "about.factRegisterVal": "VR 21688",
    "about.factCeo": "مدیرعامل",
    "about.factCeoVal": "محمد زرگرپور",
    "about.factDeputyFin": "معاون مالی",
    "about.factDeputyFinVal": "سید توفیق حسینی",
    "about.factDeputyAdmin": "معاون اداری",
    "about.factDeputyAdminVal": "محمد باقر صبوری",
    "about.factProjects": "پروژه",
    "about.factProjectsVal": "در افغانستان آغاز شده",
    "about.factFounders": "عضو مؤسس",
    "about.factFoundersVal": "۹ نفر تا امروز فعال",
    "about.historyEyebrow": "از کجا آمده‌ایم",
    "about.visionEyebrow": "به کجا می‌رویم",
    "about.boardEyebrow": "هیئت مدیره",
    "about.boardTitle": "چهره‌های پشت شاهد",
    "about.boardNote": "ثبت‌شده در دادگاه هامبورگ و مورد تأیید ادارهٴ مالیات به‌عنوان نهاد خیریه.",
    "about.photoIntro": "داوطلبان در آشپزخانهٴ افطاری",
    "about.photoHistory": "آشپزخانهٔ بزرگ با دیگ‌های پخت غذا",
    "about.photoVision": "اقلام کمکی آماده، کمی پیش از توزیع",
  },
};
